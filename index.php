...
<?php
    ...
    // ------------------------------------------------------------------ //
        ...
        $query = "SELECT * FROM tasks LIMIT {$start} , {$perPage}";
            ...
            <div> <!--col-md-offset-1  class="col-md-12"-->
                    ...
                    <tbody>
                        <?php while ($row = $rows->fetch_assoc()):?>
                            <tr>
                                <th scope="row"><?php echo $row['id']; ?></th>
                                <td><?php echo $row['name']; ?></td>
                                <td><a href="update.php?id=<?php echo $row['id'];?>&page=<?php echo $page;?>&perpage=<?php echo $perPage;?>" class="btn btn-success">Edit</a></td>
                ...
                <ul class="pagination justify-content-center" >
                    <?php for ($i=1; $i <= $pages; $i++): ?>
                        ...
                        <li class="page-item <?php echo ($page === $i) ? "active":"" ?>"><a class="page-link" href="index.php?page=<?php echo $i;?>&perpage=<?php echo $perPage;?>"><?php echo $i;?></a></li>
                    <?php endfor;?>
                </ul>
                <!-- End Pagination -->
            </div>
